...
export default function HireMee() {
  return (
    <div className="portfolio-body">
      <video className="portfolio-video hiremee" src="https://michael-siu-portfolio.s3-us-west-1.amazonaws.com/Hire-mee_Overview.mp4" alt="VIDEO NOT FOUND" loop="loop" autoPlay="autoplay" muted="muted"/>
